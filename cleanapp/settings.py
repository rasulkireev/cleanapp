"""
Django settings for cleanapp project.
...
WSGI_APPLICATION = "cleanapp.wsgi.application"
...
folder_name = f"cleanapp-{ENVIRONMENT}"
...
ACCOUNT_ADAPTER = "cleanapp.adapters.CustomAccountAdapter"
...
if ENVIRONMENT == "prod":
    ...
    LOGGING["loggers"]["cleanapp"]["level"] = env("DJANGO_LOG_LEVEL", default="INFO")
    LOGGING["loggers"]["cleanapp"]["handlers"].append("json_console")
